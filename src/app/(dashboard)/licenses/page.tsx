          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-16 text-center text-sm text-white/30">
                    No licenses found.
                  </td>
                </tr>
              ) : (
                licenses.map((license) => (
                  <tr key={license.id} className="border-b border-white/[0.03] transition-colors hover:bg-white/[0.02]">
                    <td className="px-6 py-4">
                      <code className="font-mono text-xs text-[#5f83f4]">{license.licenseKey}</code>
                      {license.client && (
                        <p className="mt-0.5 text-[11px] text-white/25">{license.client.email}</p>
                      )}
                    </td>
                    <td className="px-6 py-4 text-sm text-white/60">{license.domain}</td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          onClick={() => router.push(`/licenses/${license.id}/edit`)}
