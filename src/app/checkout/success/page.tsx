    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      <div className="glass-card w-full max-w-md p-10 text-center animate-fade-in">
        ...
        <p className="mt-3 text-sm text-white/40 leading-relaxed">
          Your subscription is active. A license key has been generated and will be sent to your email.
          You can start using the VISLI plugin on your domain immediately.
        </p>
      </div>
    </div>
  );
